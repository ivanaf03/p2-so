...
void processIn(char *trozos[], char *comando, tList *L, tListM *list_mem, int *a);
void comAutores(char *trozos[], char *comando);
void comEnd(char *trozos[], char *comando, tList *L, tListM *list_mem, int *a);
...
void comComandoN(char *trozos[], tList *L, tListM *list_mem, int *a);
